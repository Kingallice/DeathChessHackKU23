...
p1 = PlayerController.Player("Images/Pieces/CHiss.png",20,100,475,0,-20,screen,595,4)
p2 = PlayerController.Player("Images/Pieces/Pwned.png",20,1100,475,0,-20,screen,685,-4)
